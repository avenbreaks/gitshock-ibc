...
import (
	...
	incentivesmodule "neware/x/incentives"
	incentivesmodulekeeper "neware/x/incentives/keeper"
	incentivesmoduletypes "neware/x/incentives/types"
	newaremodule "neware/x/neware"
	newaremodulekeeper "neware/x/neware/keeper"
	newaremoduletypes "neware/x/neware/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "neware/app/params"
	"neware/docs"
)
...
func New(
	...
	*/
	...
	app.NewareKeeper = *newaremodulekeeper.NewKeeper(
		appCodec,
		keys[newaremoduletypes.StoreKey],
		keys[newaremoduletypes.MemStoreKey],
		app.GetSubspace(newaremoduletypes.ModuleName),
	)
	newareModule := newaremodule.NewAppModule(appCodec, app.NewareKeeper, app.AccountKeeper, app.BankKeeper)
