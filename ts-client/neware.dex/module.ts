...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgCreatePool({ value }: msgCreatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/neware.dex.MsgCreatePool", value: MsgCreatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdatePool({ value }: msgUpdatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/neware.dex.MsgUpdatePool", value: MsgUpdatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeletePool({ value }: msgDeletePoolParams): EncodeObject {
			try {
				return { typeUrl: "/neware.dex.MsgDeletePool", value: MsgDeletePool.fromPartial( value ) }  
			} catch (e: any) {
